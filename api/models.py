...
class Transaction(models.Model):
    ...
    type_of_transaction= models.CharField(max_length=30, choices=action_category, default='Credit')
    description=models.CharField(max_length=30, choices=desc_category, default='Gold')
